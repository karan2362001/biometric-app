...
def run(request):
    ...
    return render(request,"newcam.html")
...
CASCADE_PATH = 'haarcascade_frontalface_default.xml'  # Path to the face cascade XML file
...
def live_feed1(request):
    try:
        ...
        return StreamingHttpResponse(gen_frames1(camera), content_type="multipart/x-mixed-replace;boundary=frame")
